...
export type ImageFolder = "flash" | "hero" | "portfolio"
...
/**
 * Resuelve la URL final de una imagen a partir de un FormData.
 * Si hay un archivo nuevo lo sube a Supabase Storage y devuelve la URL pública.
 * Si no hay archivo devuelve la URL existente sin tocar nada.
 */
