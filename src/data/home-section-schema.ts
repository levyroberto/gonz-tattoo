...
export const SECTION_DEFINITIONS: Record<EditableSiteSectionType, SectionDefinition> = {
  ...
  aboutPage: {
    ...
    contents: ["Imagen", "Presentacion", "Frase", "Metricas"],
    creatable: false,
    deletable: false,
    titleFields: ["title"],
    fields: [
      ...
      { key: "stats", formName: "stats", label: "Metricas", type: "stats", width: "full" },
    ],
  ...
  contactPage: {
    ...
    fields: [
      ...
      { key: "cardTitle", formName: "card_title", label: "Titulo tarjeta", type: "text", required: true, width: "half" },
      { key: "cardHighlightedTitle", formName: "card_highlighted_title", label: "Titulo destacado tarjeta", type: "text", required: true, width: "half" },
      ...
      { key: "yearsLabel", formName: "years_label", label: "Label anos", type: "text", required: true, width: "half" },
      { key: "addressValue", formName: "address_value", label: "Valor direccion", type: "text", required: true, width: "third" },
      { key: "scheduleValue", formName: "schedule_value", label: "Valor horario", type: "text", required: true, width: "third" },
      { key: "directValue", formName: "direct_value", label: "Valor consulta", type: "text", required: true, width: "third" },
      { key: "directLabel", formName: "direct_label", label: "Label consulta", type: "text", required: true, width: "full" },
    ],
