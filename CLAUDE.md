...
## 10. Guía de diseño frontend

Antes de tocar cualquier código de UI, seguí estas instrucciones:

### Dirección estética

Antes de codear, definí una dirección estética BOLD y concreta:
- Elegí un tono extremo: brutalmente minimal, retro-futurista, editorial, brutalist, art deco, etc.
- Decidí qué hace esta interfaz INOLVIDABLE
- Ejecutá esa dirección con precisión en cada detalle

### Lineamientos visuales

- **TIPOGRAFÍA**: usá las fuentes ya instaladas (Bebas Neue, Playfair Display). Sacarles el máximo partido. Nunca Inter, Arial ni system fonts.
- **COLOR**: paleta cohesiva con CSS variables. Un color dominante + acento sharp. Nada de gradientes violetas genéricos.
- **MOTION**: animaciones con Framer Motion (ya instalado). Un page load bien orquestado vale más que mil micro-interacciones dispersas.
- **COMPOSICIÓN**: layouts asimétricos, overlaps, espacio negativo generoso O densidad controlada.
- **FONDOS**: texturas, grain, sombras dramáticas, no colores sólidos planos.

### Contexto del proyecto

Sitio de estudio de tatuajes old school (Gonz Tattoo, estilo tradicional/americano). Next.js 15, Tailwind 4, Framer Motion, Bebas Neue + Playfair Display.

### Proceso obligatorio para cambios de diseño

Cuando se pida pulir el diseño de una pantalla:

1. Leer este documento (`CLAUDE.md`) completo
2. Revisar los archivos del componente a modificar
3. Proponer una dirección estética concreta con palabras
4. **Esperar aprobación antes de implementar**

### Reglas técnicas de diseño

- No mover archivos sin revisar imports
- No romper Server/Client Components
- No hardcodear texto editable desde el admin
- Cambios pequeños y acotados por componente
- Respetar convenciones: kebab-case, alias `@/`, etc.
...
1. **Este documento** (`CLAUDE.md`) — contexto general y cambios recientes.
